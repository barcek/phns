...
class TestBuilder(unittest.TestCase):
    ...
    def test_get_functor(self):
        ...
        int_built = get_functor(value['int']['initial'], as_is=True)
        ...
        self.assertEqual(tuple_instantiated.value, value['iter_tuple']['initial'])
        ...
        self.assertEqual(set_instantiated.value, value['iter_set']['initial'])
        ...
        self.assertEqual(frozenset_instantiated.value, value['iter_frozenset']['initial'])
        ...
        self.assertEqual(bytearray_instantiated.value, value['iter_bytearray']['initial'])
    ...
    def test_get_pfunctor(self):
        ...
        int_built = get_pfunctor(value['int']['initial'], as_is=True)
        ...
        self.assertEqual(tuple_lifted.value, value['iter_tuple']['initial'])
        ...
        self.assertEqual(set_lifted.value, value['iter_set']['initial'])
        ...
        self.assertEqual(frozenset_lifted.value, value['iter_frozenset']['initial'])
        ...
        self.assertEqual(bytearray_lifted.value, value['iter_bytearray']['initial'])
